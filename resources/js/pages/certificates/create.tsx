...
export default function CertificatesCreate({ defaultLayout }: Props) {
    ...
    const form = useForm({
        ...
        description: '',
        is_active: '1',
        layout: defaultLayout.map((field) => ({ ...field })),
    ...
    const handleSubmit = (e: React.FormEvent<HTMLFormElement>) => {
        ...
        form.post('/admin/certificates', {
            ...
            onError: () => {
                toast.error('Gagal membuat template sertifikat.');
            },
        });
    };
    ...
    return (
        <AppLayout breadcrumbs={breadcrumbs}>
            <Head title="Tambah Template Sertifikat" />
            <div className="flex flex-1 flex-col gap-6 p-6">
                <div className="flex items-center gap-4">
                    ...
                    <div>
                        <h1 className="text-2xl font-semibold tracking-tight">Tambah Template Sertifikat</h1>
                        <p className="text-sm text-muted-foreground">
                            Upload file template dan konfigurasi dynamic fields untuk sertifikat.
                        </p>
                    </div>
                </div>
                        ...
                        <CardContent className="space-y-6">
                            ...
                            <div className="space-y-2">
                                <Label htmlFor="background_image">
                                    File Template (PDF/Gambar) <span className="text-red-500">*</span>
                                </Label>
                                <Input
                                    id="background_image"
                                    type="file"
                                ...
                                <p className="text-xs text-muted-foreground">
                                    Format: JPG, PNG, WEBP, PDF. Max: 8MB
                                </p>
