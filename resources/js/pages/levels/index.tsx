...
export default function Index({ levels }: Props) {
    ...
    const openEditDialog = (level: Level) => {
        ...
        setEditPreview(resolveImageUrl(level.image));
        setEditOpen(true);
    };
                ...
                return (
                    <div className="flex justify-end">
                        <CrudActions
                            ...
                            onDelete={() => openDeleteDialog(level)}
                        />
                    </div>
                );
            },
                ...
                <div className="flex flex-wrap items-center justify-between gap-3">
                    <div>
                        ...
                        <p className="text-sm text-muted-foreground">
                            Buat, ubah, dan kelola tingkat kesulitan kelas di platform.
                        </p>
                    </div>
            ...
            <Dialog open={createOpen} onOpenChange={setCreateOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Buat level kesulitan baru untuk kelas Anda
                        </DialogDescription>
                    </DialogHeader>
                    <form onSubmit={handleCreate}>
                        <div className="space-y-4 py-4">
                            <div className="space-y-2">
                                <Label htmlFor="create-name">Nama Level</Label>
                                <Input
                                    id="create-name"
            ...
            <Dialog open={editOpen} onOpenChange={setEditOpen}>
                <DialogContent>
                    <DialogHeader>
                        ...
                        <DialogDescription>
                            Perbarui informasi level kesulitan
                        </DialogDescription>
                    </DialogHeader>
                ...
                <AlertDialogContent>
                    <AlertDialogHeader>
                        ...
                        <AlertDialogDescription>
                            ...
                            {selectedLevel?.name}"? Tindakan ini tidak dapat
                            dibatalkan.
                        </AlertDialogDescription>
                    </AlertDialogHeader>
                    <AlertDialogFooter>
