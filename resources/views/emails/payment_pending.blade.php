...
<head>
    <meta charset="utf-8">
    <title>Menunggu Pembayaran - {{ $appName }}</title>
</head>
    ...
    <div style="max-width:600px;margin:0 auto;background-color:#ffffff;border-radius:12px;overflow:hidden;box-shadow:0 10px 30px rgba(15,23,42,0.12);">
                ...
                <tr>
                    <td align="left">
                        ...
                        <div style="margin-top:4px;font-size:13px;color:rgba(241,245,249,0.92);">
                            Transaksi kamu sudah kami terima. Silakan selesaikan pembayaran.
                        </div>
                    </td>
                </tr>
            </table>
        ...
        <div style="padding:24px 24px 8px 24px;">
            ...
            <p style="margin:0 0 12px 0;font-size:14px;line-height:1.7;color:#4b5563;">
                Kami sudah membuat transaksi untuk pembelian kelas kamu. Segera selesaikan pembayaran agar akses kelas bisa aktif.
            </p>
            ...
            <div style="margin:20px 0;padding:16px 16px 14px 16px;border-radius:10px;background-color:#f9fafb;border:1px solid #e5e7eb;">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" role="presentation" style="font-size:14px;color:#111827;">
                    ...
                    @if(!empty($expiredAt))
                        <tr>
                            <td style="padding:4px 0;color:#6b7280;">Berlaku sampai</td>
                            <td style="padding:4px 0;font-weight:500;">
                                {{ \Illuminate\Support\Carbon::parse($expiredAt)->format('d M Y H:i') }} WIB
                            </td>
                        </tr>
                    @endif
                </table>
            ...
            <p style="margin:0 0 16px 0;font-size:14px;line-height:1.7;color:#4b5563;">
                Gunakan tombol berikut untuk melanjutkan pembayaran atau melihat instruksi lengkap.
            </p>
        ...
        <div style="padding:0 24px 24px 24px;border-top:1px solid #e5e7eb;">
            <p style="margin:12px 0 4px 0;font-size:13px;line-height:1.6;color:#6b7280;">
                Jika kamu merasa tidak melakukan transaksi ini, segera hubungi tim dukungan {{ $appName }}.
            </p>
